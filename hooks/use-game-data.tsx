...
const defaultGameData: GameData = {
    ...
    },
    {
      ...
      questions: [
        ...
        },
        {
          id: uuidv4(),
          value: 400,
          question: "This Egyptian queen was known for her relationship with Mark Antony",
        ...
        },
        {
          id: uuidv4(),
          value: 800,
          question: "This U.S. President delivered the Gettysburg Address",
        ...
        },
        {
          id: uuidv4(),
          value: 1000,
          question: "The ancient city that was destroyed by Mount Vesuvius",
    ...
    },
    {
      ...
      questions: [
        ...
        },
        {
          id: uuidv4(),
          value: 400,
          question: "The number of films in the original Star Wars trilogy",
          answer: "What is 3?",
          used: false,
        },
        {
          id: uuidv4(),
          value: 600,
          question: "This TV show features characters named Ross, Rachel, and Joey",
    ...
    },
    {
      ...
      questions: [
        ...
        },
        {
          id: uuidv4(),
          value: 800,
          question: "The number of points scored for a touchdown in American football",
          answer: "What is 6?",
          used: false,
        },
        {
      ...
      questions: [
        {
          id: uuidv4(),
          value: 200,
          question: "The author of 'Romeo and Juliet'",
        ...
        },
        {
          id: uuidv4(),
          value: 400,
          question: "This character says 'Elementary, my dear Watson'",
        ...
        },
        {
          id: uuidv4(),
          value: 600,
          question: "The first book in J.K. Rowling's wizard series",
          answer: "What is Harry Potter and the Philosopher's/Sorcerer's Stone?",
          used: false,
        },
        {
          id: uuidv4(),
        ...
        },
        {
          id: uuidv4(),
          value: 1000,
          question: "This dystopian novel by George Orwell features Big Brother",
          answer: "What is 1984?",
          used: false,
        },
      ],
  ...
  settings: {
    ...
    finalJeopardyQuestion: "This Shakespeare character said, 'To be, or not to be: that is the question'",
...
const GameDataContext = createContext<
  | {
      ...
      resetGame: () => void
      markQuestionAsUsed: (categoryIndex: number, questionIndex: number) => void
      updateGameSettings: (settings: Partial<GameSettings>) => void
      updateFinalJeopardy: (category: string, question: string, answer: string) => void
    }
  | undefined
>(undefined)
...
export function GameDataProvider({ children }: { children: ReactNode }) {
  ...
  const markQuestionAsUsed = (categoryIndex: number, questionIndex: number) => {
  ...
  const updateFinalJeopardy = (category: string, question: string, answer: string) => {
    setGameData({
      ...gameData,
      settings: {
        ...gameData.settings,
